...
export const NewsAndEventBanner = ({
    bannerImage,
    title,
    description,
}: {
  ...
  return (
    ...
    className='h-[calc(100vh-30vh)] w-full flex bg-gradient-to-b bg-black/50 bg-top bg-blend-overlay relative bg-cover bg-center bg-no-repeat text-blue-50 bg-fixed'>
