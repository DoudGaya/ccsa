...
export default function TeamMemberCard({ member }: TeamMemberCardProps) {
  ...
  <div className=" flex flex-col space-y-3 items-center w-full">
    <Image
      ...
      height={500}
      width={500}
      className={`transition-opacity ${member.priority ? 'w-[200px] h-[200px]' : 'w-[120px] h-[120px] '}  object-cover rounded-full object-[50%_25%] border-2 border-blue-950 duration-300 ease-in-out group-hover:opacity-75`}
    />
