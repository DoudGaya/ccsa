    ...
    <div className=" flex flex-col px-8 mx-auto text-center container space-y-4">
      <h2 className="text-2xl font-semibold mt-6 mb-4">{card.title}</h2>
            <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {
                ...
                <div key={index} className="bg-blue-100 md:text-start items-center flex flex-col md:items-start py-10 space-y-2 p-4 rounded-lg mb-4">
      ...
      <div className="bg-gray-100 w-full mx-auto p-4 rounded-lg mt-6">
